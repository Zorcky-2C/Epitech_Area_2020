...
public class EpictureMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(EpictureMain.this, ProfileImgur.class));
            }
        });
    ...
    public void uploadImage() {
        ...
        Request request = new Request.Builder()
                ...
                //.get()
                .url("http://10.0.2.2:8080/ImgurAuth/HomePage")
                .post(body)
                .build();
    ...
    private void render(final List<Photo> photos)
    {
        ...
        RecyclerView.Adapter<PhotoVH> adapter = new RecyclerView.Adapter<PhotoVH>()
        {
            ...
            public void onBindViewHolder(@NonNull PhotoVH holder, int position)
            {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            Request request = new Request.Builder()
                                    .url("http://10.0.2.2:8080/ImgurAuth/Image")
                                    .get()
                                    .build();
                ...
                Picasso.with(EpictureMain.this)
